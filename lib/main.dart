...
import 'screens/ntt_point_history_screen.dart';
...
import 'utils/web_utils.dart' if (dart.library.html) 'utils/web_utils_web.dart';
import 'firebase_options.dart';
import 'package:timeago/timeago.dart' as timeago;

// Tạo global navigator key để sử dụng trong toàn bộ ứng dụng
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (context) => AIAgentService()),
      ],
        ...
        builder: (context, themeService, child) {
          return MaterialApp(
            ...
            routes: {
              ...
              AIAgentDashboardScreen.routeName: (ctx) => const AIAgentDashboardScreen(),
              AIAgentReportScreen.routeName: (ctx) => const AIAgentReportScreen(),
            },
          );
        },
      ),
...
class MyApp extends StatefulWidget {
  ...
  const MyApp({Key? key, required this.aiAgentService}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider.value(value: widget.aiAgentService),
      ],
      child: Consumer<ThemeService>(
        builder: (context, themeService, child) {
          return MaterialApp(
